...
public final class Mp3Encoder {
     ...
     */
    public static native void init(int inSampleRate, int inChannel, int outSampleRate, int outBitrate, int quality);
     ...
     */
    public static native int encode(short[] bufferLeft, short[] bufferRight, int samples, byte[] mp3buf);
