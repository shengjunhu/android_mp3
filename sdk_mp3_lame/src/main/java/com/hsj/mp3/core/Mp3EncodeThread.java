 ...
 * @Desc:
 */
public final class Mp3EncodeThread extends HandlerThread implements AudioRecord.OnRecordPositionUpdateListener {
     ...
     */
    public Mp3EncodeThread(File file, int bufferSize) throws FileNotFoundException {
